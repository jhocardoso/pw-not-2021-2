// Função tradiconal com 1 parâmetro e 1 linha de cósigo no corpo, com return
function quadrado(x) {
    return x * x    // n ** 2
}
...
// 4) Após p parâmetro, aparece o símbolo => (flecha, arrow)
...
// Função tradicional sem parêmetros, 1 linha de corpo com return
function horaAtual() {
    return new Date()
}
...
console.log(horaAtual().toLocaleTimeString('pt-br', {timeZone: 'America/Sao_Paulo'}))
